  ...
  // Function to highlight or click the corresponding color button
  function handleColorKeyPress(key) {
    const color = keyToColor[key];
    if (color) {
      // Find the button for the color and simulate a click
